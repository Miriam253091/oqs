	        ...
	        <# if ( payment ) { #>
	            ...
	            <div class="donate_compensates">
	                <ul>
	                    ...
	                    <li>
				            <h4><?php _e( 'Cantidaa a donar: ', 'tp-donate' ); ?></h4>
	            ...
	            <div class="donate_donor_info">
	        		...
	        		<h3><?php _e( 'Información Personal', 'tp-donate' ) ?></h3>

	        		<div class="donate_field">
	        			<input name="first_name" id="first_name" class="first_name" placeholder="<?php _e( '* Nombre', 'tp-donate' ) ?>" />
	        		</div>

	        		<div class="donate_field">
	        			<input name="last_name" id="last_name" class="last_name" placeholder="<?php _e( '* Apellido', 'tp-donate' ) ?>" />
	        		</div>
	        		...
	        		<div class="donate_field">
	        			<input name="phone" id="phone" class="phone" placeholder="<?php _e( '* Teléfono', 'tp-donate' ) ?>" />
	        		</div>

	        		<div class="donate_field">
	        			<textarea name="address" id="address" class="address" placeholder="<?php _e( '* Dirección', 'tp-donate' ) ?>"></textarea>
	        		</div>

	        		<div class="donate_field">
	        			<textarea name="addition" id="addition" class="addition" placeholder="<?php _e( 'Comentarios Adicionales', 'tp-donate' ) ?>"></textarea>
	        		</div>
...
<!--WEEEEEEEEE-->
					<div class="donate_term_condition">
						...
						<label for="term_condition">
							<?php _e( 'Terminos y condiciones', 'tp-donate' ); ?>
						</label>
					</div>
            	...
            	<div class="donate_form_footer center">
            		...
            		<button type="submit" class="donate_submit button payment" form="donate_form"><?php _e( 'Donar', 'tp-donate' ) ?></button>
            ...
            <# } else { #>
            	...
            	<div class="donate_form_footer">
		            ...
		            <h4><?php _e( 'Cantidad a Donar: ', 'tp-donate' ); ?></h4>

		            <span class="currency">{{{ data.currency_symbol }}}</span>

		            <input type="number" name="donate_input_amount" step="any" class="donate_form_input" min="0"/>
	            	<button type="submit" class="donate_submit button" form="donate_form"><?php _e( 'Donar', 'tp-donate' ) ?></button>
