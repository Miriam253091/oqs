		...
		<article class="the_article textwidget">
			...
			<div class="sponsor_pool">
				...
				<ul class="sponsor_list ul_4" >
					...
					<li class="sponsor_item" >
						<img src="http://www.ojosquesienten.com/wp-content/uploads/2017/07/gex_logo_imagen.jpg">
					</li>
					<li class="sponsor_item" >
