...
$custom_url = get_field('head_image');

if ($custom_url){
$c_css = 'style="background-image: url(' . $custom_url . ')"';
} else {
	$c_css;
}
////////////////
...
<?php if ( $hide_title != '1' ) { ?>
	...
	}else{echo ' thim-parallax-image';} ?>" <?php echo ent2ncr( $c_css ); ?> data-stellar-background-ratio="0.5">
